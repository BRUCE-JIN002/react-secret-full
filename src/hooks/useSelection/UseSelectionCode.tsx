...
const UseSelectionCode: React.FC = () => {
  return (
    <Code
      codeString={useSelectionCodeString}
      fileName="useSelection.ts"
      id={HooksType.UseSelection}
    />
  );
};

export default UseSelectionCode;

const useSelectionCodeString = `import { useSafeState, useCreation } from "ahooks";
