...
const UseFullscreenCode: React.FC = () => {
  return (
    <Code
      codeString={useFullscreenCodeString}
      fileName="useFullscreen.ts"
      id={HooksType.UseFullscreen}
    />
  );
};

export default UseFullscreenCode;

const useFullscreenCodeString = `import screenfull from "screenfull";
