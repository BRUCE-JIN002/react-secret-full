...
const UseCountdownCode: React.FC = () => {
  return (
    <Code
      codeString={useCountdownCodeString}
      fileName="useCount.ts"
      id={HooksType.UseCountDown}
    />
  );
};

export default UseCountdownCode;

const useCountdownCodeString = `import dayjs from "dayjs";
