...
const UseInViewportCode: React.FC = () => {
  return (
    <Code
      codeString={useInViewportCodeString}
      fileName="useInViewport.ts"
      id={HooksType.UseInViewport}
    />
  );
};

export default UseInViewportCode;

const useInViewportCodeString = `import { useSafeState } from "ahooks";
