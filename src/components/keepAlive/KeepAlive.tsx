...
interface Props {
   ...
   */
  aliveRef?:
    | RefObject<KeepAliveRef | undefined>
    | MutableRefObject<KeepAliveRef | undefined>;
  ...
  useLayoutEffect(() => {
    ...
    setCacheNodes((prevCacheNodes) => {
      ...
      if (cacheNode) {
        ...
        return [
          ...prevCacheNodes,
          { name: activeName, cache, lastActiveTime, ele: children },
        ];
      }
    });
  }, [
